...
from swift.llm import PtEngine, RequestConfig, BaseArguments, InferRequest, safe_snapshot_download,draw_bbox, load_image
...
model_path = r'/media/ubuntu2204/0F0F19200F0F1920/testai/7B/Qwen2.5-VL-7B-Instruct' # m\模型路径
...
def ask(question:str,resized_image):
    ...
    inputs = processor(text=[text_prompt], images=[resized_image], padding=True, return_tensors="pt")
